   ...
   <main class="wrapper">
      ...
      <div class="main-content">
       <?php
        ...
        $toAddress = "huangritafifi@gamil.com";  //place your/your client's email address  here
         $toName = "Fiona Fay"; //place your client's name here
         $website = "Contact For Test";  //place NAME of your client's website
